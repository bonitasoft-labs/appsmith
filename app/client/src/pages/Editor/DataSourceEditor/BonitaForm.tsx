...
interface DatasourceBonitaEditorProps extends JSONtoFormProps {
  datasourceId: string;
...
type Props = DatasourceBonitaEditorProps &
  InjectedFormProps<Datasource, DatasourceBonitaEditorProps>;
...
class DatasourceBonitaEditor extends JSONtoForm<Props> {
  openDocumentation = () => {
...
export default connect(mapStateToProps)(
  reduxForm<Datasource, DatasourceBonitaEditorProps>({
